...
function Home(props) {
    ...
    return (
        <div className="container">
            ...
            <Home_Product gender={`Giầy Nike`} category={'6833e447c948edd27cfc5263'} GET_id_modal={GET_id_modal} />

            <Home_Product gender={`Giầy Adidas`} category={'684ab9553a9fd95dd4f69b8c'} GET_id_modal={GET_id_modal} />
            <Home_Product gender={`Giầy Lacoste`} category={'684ab96b3a9fd95dd4f69b8d'} GET_id_modal={GET_id_modal} />
            <Home_Product gender={`Giầy Puma`} category={'684ab9733a9fd95dd4f69b8e'} GET_id_modal={GET_id_modal} />
            <Home_Product gender={`Giầy Thể Thao`} category={'684ab9903a9fd95dd4f69b8f'} GET_id_modal={GET_id_modal} />
